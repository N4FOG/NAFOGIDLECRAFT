...
const outputPath = path.join(__dirname, 'img', '11_pickaxe.png');
const backupPath = path.join(__dirname, 'img', '11_pickaxe_original_backup.png');
...
console.log(`Successfully removed background! Processed ${width}x${height} pixels. Saved transparent PNG to ${outputPath}`);
