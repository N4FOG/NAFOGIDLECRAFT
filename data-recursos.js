...
// ============================================
        ...
        // ============================================
        const potions = [
            { id: 'speed_potion', name: 'Poção de Velocidade', icon: '⚡', description: 'Aumenta sua velocidade de coleta', effect: '+50% velocidade', duration: 300, craftTime: 10, levelReq: 15, ingredients: [{ type: 'fish2', qty: 3 }, { type: 'wood2', qty: 5 }], effectType: 'speed', effectValue: 50 },
            { id: 'luck_potion', name: 'Poção de Sorte', icon: '🍀', description: 'Aumenta chances de crítico', effect: '+30% chance crítico', duration: 600, craftTime: 15, levelReq: 85, ingredients: [{ type: 'fish5', qty: 1 }, { type: 'wood4', qty: 3 }], effectType: 'luck', effectValue: 30 },
            { id: 'strength_potion', name: 'Poção de Força', icon: '💪', description: 'Aumenta força temporariamente', effect: '+20 força', duration: 180, craftTime: 12, levelReq: 40, ingredients: [{ type: 'bar3', qty: 2 }, { type: 'fish3', qty: 3 }], effectType: 'strength', effectValue: 20 },
            { id: 'xp_potion', name: 'Poção do Sábio', icon: '📚', description: 'Dobra o ganho de XP', effect: '+100% XP', duration: 900, craftTime: 20, levelReq: 90, ingredients: [{ type: 'wood5', qty: 2 }, { type: 'ore5', qty: 2 }], effectType: 'xpBoost', effectValue: 100 },
            { id: 'gold_potion', name: 'Poção do Mercador', icon: '💰', description: 'Aumenta ouro obtido', effect: '+50% ouro', duration: 600, craftTime: 15, levelReq: 65, ingredients: [{ type: 'bar4', qty: 2 }, { type: 'cookedFish4', qty: 2 }], effectType: 'goldBoost', effectValue: 50 },
            { id: 'instant_heal', name: 'Poção de Cura', icon: '❤️', description: 'Cura instantaneamente', effect: 'Cura 50% da vida', duration: 0, craftTime: 5, levelReq: 60, ingredients: [{ type: 'cookedFish2', qty: 3 }, { type: 'fish4', qty: 2 }], effectType: 'heal', effectValue: 50 },
            { id: 'fire_oil', name: 'Óleo de Fogo', icon: '🔥', description: 'Arma flamejante que aumenta seu dano global', effect: '+25% dano combate', duration: 300, craftTime: 12, levelReq: 20, ingredients: [{ type: 'wood2', qty: 6 }, { type: 'bar2', qty: 3 }], effectType: 'combatMult', effectValue: 25 },
            { id: 'poison_oil', name: 'Óleo de Veneno', icon: '🧪', description: 'Arma venenosa que rouba vida ao atacar', effect: '+15% roubo de vida', duration: 300, craftTime: 12, levelReq: 35, ingredients: [{ type: 'fish3', qty: 4 }, { type: 'wood3', qty: 6 }], effectType: 'lifesteal_pot', effectValue: 15 },
            { id: 'builder_elixir', name: 'Elixir do Construtor', icon: '🔨', description: 'Reduz o tempo de fabricação de itens', effect: '-20% tempo craft', duration: 600, craftTime: 15, levelReq: 60, ingredients: [{ type: 'bar3', qty: 3 }, { type: 'wood4', qty: 8 }], effectType: 'craftSpeed_pot', effectValue: 20 },
            { id: 'meistre_elixir', name: 'Elixir do Meistre', icon: '📜', description: 'Concentração profunda que concede XP extra', effect: '+25% XP global', duration: 600, craftTime: 20, levelReq: 85, ingredients: [{ type: 'wood5', qty: 3 }, { type: 'bar4', qty: 4 }], effectType: 'xpBoost_all_pot', effectValue: 25 }
        ];
